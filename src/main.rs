...
//TODO: appropriate error checking
//TODO: accept an alternate wordlist from the command line
//TODO: add the capability for longer words
//TODO: add a capability for player to guess the word at any time
            ...
            Ok(_n) => {
                ...
                if answer.check_for_letter(letter) {
                    println!(
                        ...
                        so the word is {}", letter, answer.representation
                    );
                } else {
